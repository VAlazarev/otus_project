...
Процедура НеотработанныеЗаказы() Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ПРЕДСТАВЛЕНИЕССЫЛКИ(ЗаказКлиента.Ссылка) КАК СсылкаПредставление,
	               |	ЗаказКлиента.Сумма КАК Сумма,
	               |	ЗаказКлиента.Покупатель КАК Покупатель,
	               |	ПРЕДСТАВЛЕНИЕССЫЛКИ(ЗаказКлиента.Покупатель) КАК ПокупательПредставление
	               |ИЗ
	               |	Документ.ЗаказКлиента КАК ЗаказКлиента
	               |ГДЕ
	               |	ЗаказКлиента.ПометкаУдаления = ЛОЖЬ
	               |	И ЗаказКлиента.СостояниеЗаказа <> ЗНАЧЕНИЕ(Перечисление.СостоянияЗаказов.Закрыт)
	               |	И ЗаказКлиента.СостояниеЗаказа <> ЗНАЧЕНИЕ(Перечисление.СостоянияЗаказов.Выполнен)
